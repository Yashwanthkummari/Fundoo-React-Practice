...
const Register = () => {
    ...
    return (
        <div className="name">
            <div className="name2">
                <div className="name1">
                    <h1 className="H"><span className="f">F</span><span className="u">U</span><span className="n">N</span><span className="d">D</span><span className="O">O</span><span className="o">O</span></h1>
                    ...
                    <div className="center">
                        <a href="/" className="center2" > Sign In Instead</a>
